...
void get_sample_docs(struct Document* docs) {
  ...
  create_new_document(&doc_1, id_1, title_1, authors_1, authornum_1, abstract_1);
  docs[0] = doc_1;
  ...
  create_new_document(&doc_2, id_2, title_2, authors_2, authornum_2, abstract_2);
  docs[1] = doc_2;
  ...
  create_new_document(&doc_3, id_3, title_3, authors_3, authornum_3, abstract_3);
  docs[2] = doc_3;
  ...
  create_new_document(&doc_4, id_4, title_4, authors_4, authornum_4, abstract_4);
  docs[3] = doc_4;
  ...
  create_new_document(&doc_5, id_5, title_5, authors_5, authornum_5, abstract_5);
  docs[4] = doc_5;
}
